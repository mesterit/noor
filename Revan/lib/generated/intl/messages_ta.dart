...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => " ${number}குழுக்களாக வாங்க வேண்டும்";

  static String m24(itemCount) => " பொருட்கள்";

  static String m25(price) => "மொத்த தெரிவுகள்: ";

  static String m26(amount) => " ${amount}செலுத்துங்கள்";

  static String m27(total) => "அளவு: ${total}";

  static String m28(percent) => "தள்ளுபடி ";

  static String m29(second) => "விநாடிகளுக்கு முன்னர்";

  static String m30(totalCartQuantity) => "ஷாப்பிங் கார்ட் பொருட்கள்";

  static String m31(numberOfUnitsSold) => "விற்பனையானவை";

  static String m32(fieldName) => " ${fieldName} புலம் தேவை";

  static String m33(total) => " மொத்த பொருட்கள்";
  ...
  static String m35(date) => "செல்லுபடியாகும் திகதி";

  static String m36(message) => "எச்சரிக்கை";
  ...
  static String m38(length) => "மேலதிகப் பொருட்கள்";

  static String m39(week) => "வாரம் ${week}";

  static String m40(name) => "வரவேற்கிறோம் ${name}";

  static String m41(year) => "${year} ஆண்டுகளுக்கு முன்பு";

  static String m42(total) =>
