...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "phải mua theo nhóm ${number}";

  static String m24(itemCount) => "${itemCount} mặt hàng";

  static String m25(price) => "Tổng số tùy chọn: ${price}";

  static String m26(amount) => "Thanh toán ${amount}";

  static String m27(total) => "Số lượng: ${total}";

  static String m28(percent) => "Sale ${percent} %";

  static String m29(second) => "${second} giây trước";

  static String m30(totalCartQuantity) =>
      "Giỏ hàng, ${totalCartQuantity} sản phẩm";

  static String m31(numberOfUnitsSold) => "Đã bán: ${numberOfUnitsSold}";

  static String m32(fieldName) => "Trường ${fieldName} là bắt buộc";

  static String m33(total) => "${total} sản phẩm";
  ...
  static String m35(date) => "Có hiệu lực cho đến ${date}";

  static String m36(message) => "Cảnh báo: ${message}";
  ...
  static String m38(length) => "Chúng tôi tìm thấy ${length} sản phẩm";

  static String m39(week) => "Tuần ${week}";

  static String m40(name) => "Chào mừng ${name}";

  static String m41(year) => "${year} năm trước";

  static String m42(total) => "Bạn đã chỉ định đơn đặt hàng số${total}";
