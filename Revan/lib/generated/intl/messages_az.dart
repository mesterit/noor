...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => " ${number}qruplarında alınmalıdır";

  static String m24(itemCount) => "${itemCount} məhsul";

  static String m25(price) => "Cəmi seçimlər: ${price}";

  static String m26(amount) => " ${amount}ödəyin";

  static String m27(total) => "Miqdar: ${total}";

  static String m28(percent) => "Endirim ${percent}%";

  static String m29(second) => "${second} saniyə öncə";

  static String m30(totalCartQuantity) =>
      "Səbətdə ${totalCartQuantity} məhsul var";

  static String m31(numberOfUnitsSold) => "Satıldı: ${numberOfUnitsSold}";

  static String m32(fieldName) => " ${fieldName} sahəsi tələb olunur";

  static String m33(total) => "${total} məhsul";
  ...
  static String m35(date) => " ${date}tarixinə qədər etibarlıdır";

  static String m36(message) => "Xəbərdarlıq: ${message}";
  ...
  static String m38(length) => "${length} məhsul tapıldı";

  static String m39(week) => "Həftə ${week}";

  static String m40(name) => "Xoş gəldiniz ${name}";

  static String m41(year) => "${year} il əvvəl";

  static String m42(total) => "Siz №${total}sifarişi təyin etdiniz";
