...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "мора се купити у групама од ${number}";

  static String m24(itemCount) => "${itemCount} Ставка";

  static String m25(price) => "Укупно опција: ${price}";

  static String m26(amount) => "Плати ${amount}";

  static String m27(total) => "Količina: ${total}";

  static String m28(percent) => "Распродај ${percent} %";

  static String m29(second) => "Пре ${second} Минута";

  static String m30(totalCartQuantity) =>
      "корпа, ${totalCartQuantity} предмета";

  static String m31(numberOfUnitsSold) => "продато: ${numberOfUnitsSold}";
  ...
  static String m35(date) => "Датум истека ${date}";

  static String m36(message) => "упозорење: ${message}";
  ...
  static String m38(length) => "Пронашли смо производе";

  static String m39(week) => " ${week}. Sedmica";

  static String m40(name) => "Добро дошли ${name}";

  static String m41(year) => " Prije${year} godina";

  static String m42(total) => "Dodijelili ste narudžbi br.${total}";
