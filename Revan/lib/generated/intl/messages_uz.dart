...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => " ${number}ta guruhlarda sotib olinishi kerak";

  static String m24(itemCount) => "${itemCount} ta element";

  static String m25(price) => "Jami variantlar: ${price}";

  static String m26(amount) => " ${amount}toʻlash";

  static String m27(total) => "Miqdor: ${total}";

  static String m28(percent) => "Sotish: ${percent}%";

  static String m29(second) => "${second} soniya oldin";

  static String m30(totalCartQuantity) =>
      "Savat savati, ${totalCartQuantity} ta mahsulot";

  static String m31(numberOfUnitsSold) => "Sotilgan: ${numberOfUnitsSold}";

  static String m32(fieldName) => " ${fieldName} maydoni to\'ldirilishi shart";

  static String m33(total) => "${total} ta mahsulot";
  ...
  static String m35(date) => " ${date}gacha amal qiladi";

  static String m36(message) => "Ogohlantirish: ${message}";
  ...
  static String m38(length) => "Biz ${length} ta mahsulotni topdik";

  static String m39(week) => " ${week}hafta";

  static String m40(name) => "Xush kelibsiz ${name}";

  static String m41(year) => "${year} yil oldin";

  static String m42(total) => "Siz buyurtma berdingiz:${total}";
