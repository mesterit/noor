...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "moet worden gekocht in groepen van ${number}";

  static String m24(itemCount) => "${itemCount} items";

  static String m25(price) => "Opties totaal: ${price}";

  static String m26(amount) => "Betaal ${amount}";

  static String m27(total) => "Aantal: ${total}";

  static String m28(percent) => "Verkoop ${percent} %";

  static String m29(second) => "${second} seconden geleden";

  static String m30(totalCartQuantity) =>
      "Winkelwagen, ${totalCartQuantity} artikelen";

  static String m31(numberOfUnitsSold) => "Verkocht: ${numberOfUnitsSold}";

  static String m32(fieldName) => "Het veld ${fieldName} is verplicht";

  static String m33(total) => "${total} producten";
  ...
  static String m35(date) => "Geldig tot ${date}";

  static String m36(message) => "Waarschuwing: ${message}";
  ...
  static String m38(length) => "We hebben ${length} producten gevonden";

  static String m39(week) => "Week ${week}";

  static String m40(name) => "Welkom ${name}";

  static String m41(year) => "${year} jaar geleden";

  static String m42(total) => "Je hebt toegewezen aan bestelling #${total}";
