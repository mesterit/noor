...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "należy kupować w grupach po ${number}";

  static String m24(itemCount) => "${itemCount} elementów";

  static String m25(price) => "Łącznie opcje: ${price}";

  static String m26(amount) => "Zapłać ${amount}";

  static String m27(total) => "Ilość: ${total}";

  static String m28(percent) => "Wyprzedaż ${percent}%";

  static String m29(second) => "${second} sekundy temu";

  static String m30(totalCartQuantity) =>
      "Koszyk, ${totalCartQuantity} pozycje";

  static String m31(numberOfUnitsSold) => "Sprzedane: ${numberOfUnitsSold}";

  static String m32(fieldName) => "Pole ${fieldName} jest wymagane";

  static String m33(total) => "${total} produktów";
  ...
  static String m35(date) => "Ważne do ${date}";

  static String m36(message) => "Ostrzeżenie: ${message}";
  ...
  static String m38(length) => "Znaleźliśmy ${length} produktów";

  static String m39(week) => "Tydzień ${week}";

  static String m40(name) => "Witamy ${name}";

  static String m41(year) => "${year} lat temu";

  static String m42(total) => "Przypisałeś do zamówienia nr${total}";
