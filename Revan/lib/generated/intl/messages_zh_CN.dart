...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "必须以 ${number}为一组购买";

  static String m24(itemCount) => "${itemCount} 项";

  static String m25(price) => "选项总数： ${price}";

  static String m26(amount) => "支付 ${amount}";

  static String m27(total) => "数量： ${total}";

  static String m28(percent) => "销售额 ${percent}%";

  static String m29(second) => "${second} 秒前";

  static String m30(totalCartQuantity) => "购物车， ${totalCartQuantity} 件商品";

  static String m31(numberOfUnitsSold) => "已售出： ${numberOfUnitsSold}";

  static String m32(fieldName) => " ${fieldName} 字段是必需的";

  static String m33(total) => "${total} 个商品";

  static String m34(maxPointDiscount, maxPriceDiscount) =>
      "最多使用 ${maxPointDiscount} 点积分即可获得此订单的 ${maxPriceDiscount} 折扣！";

  static String m35(date) => "有效期至 ${date}";
  ...
  static String m38(length) => "我们找到了 ${length} 件商品";

  static String m39(week) => "第 ${week} 周";

  static String m40(name) => "欢迎 ${name}";

  static String m41(year) => "${year} 年前";

  static String m42(total) => "您已指定订单 #${total}";
