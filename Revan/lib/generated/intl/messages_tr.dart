...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) =>
      " ${number}kişilik gruplar halinde satın alınmalıdır";

  static String m24(itemCount) => "${itemCount} ürün";

  static String m25(price) => "Toplam seçenek: ${price}";

  static String m26(amount) => " ${amount}öde";

  static String m27(total) => "Adet: ${total}";

  static String m28(percent) => "% ${percent} İndirim ";

  static String m29(second) => "${second} Saniye önce";

  static String m30(totalCartQuantity) => "${totalCartQuantity} ürün, Sepette";

  static String m31(numberOfUnitsSold) => "Sold: ${numberOfUnitsSold}";

  static String m32(fieldName) => " ${fieldName} alanı zorunludur";

  static String m33(total) => "${total} ürün";
  ...
  static String m35(date) => " ${date}tarihine kadar geçerlidir";

  static String m36(message) => "Hata: ${message}";
  ...
  static String m38(length) => " \$${length} Ürün Bulundu";

  static String m39(week) => " ${week}haftası";

  static String m40(name) => "Hoş geldiniz ${name}";

  static String m41(year) => "${year} yıl önce";

  static String m42(total) => "#${total}numaralı siparişe atadınız";
