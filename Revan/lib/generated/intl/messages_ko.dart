...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => " ${number}그룹으로 구매해야 합니다.";

  static String m24(itemCount) => "${itemCount} 항목";

  static String m25(price) => "총 옵션 : ${price}";

  static String m26(amount) => " ${amount}지불";

  static String m27(total) => "수량: ${total}";

  static String m28(percent) => "판매 ${percent} %";

  static String m29(second) => "${second} 초 전";

  static String m30(totalCartQuantity) => "장바구니, ${totalCartQuantity} 개 항목";

  static String m31(numberOfUnitsSold) => "판매 : ${numberOfUnitsSold}";

  static String m32(fieldName) => " ${fieldName} 필드는 필수 항목입니다.";

  static String m33(total) => "${total} 제품";

  static String m34(maxPointDiscount, maxPriceDiscount) =>
      "이 주문에 ${maxPriceDiscount} 할인을 위해 최대 ${maxPointDiscount} 포인트를 사용하세요!";

  static String m35(date) => " ${date}까지 유효";

  static String m36(message) => "경고 : ${message}";

  static String m37(defaultCurrency) =>
      "현재 선택한 통화는 지갑 기능에 사용할 수 없습니다. ${defaultCurrency}(으)로 변경하십시오.";

  static String m38(length) => " ${length} 개의 제품을 찾았습니다.";

  static String m39(week) => "주 ${week}";

  static String m40(name) => "환영합니다 ${name}";

  static String m41(year) => "${year} 년 전";

  static String m42(total) => "주문 번호${total}에 할당했습니다.";
