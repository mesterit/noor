...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "debe comprarse en grupos de ${number}";

  static String m24(itemCount) => "${itemCount} items";

  static String m25(price) => "Total de opciones: ${price}";

  static String m26(amount) => "Pagar ${amount}";

  static String m27(total) => "Cantidad: ${total}";

  static String m28(percent) => "Rebaja ${percent} %";

  static String m29(second) => "${second} segundos";
  ...
  static String m32(fieldName) => "El campo ${fieldName} es obligatorio";

  static String m33(total) => "${total} Productos";
  ...
  static String m35(date) => "Válido hasta ${date}";

  static String m36(message) => "Advertencia: ${message}";
  ...
  static String m38(length) => "Encontramos productos de ${length}";

  static String m39(week) => "Semana ${week}";

  static String m40(name) => "Bienvenido ${name}";

  static String m41(year) => " Hace${year} años";

  static String m42(total) => "Ha asignado a la orden #${total}";
