...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "je potrebné zakúpiť v skupinách po ${number}";

  static String m24(itemCount) => " ${itemCount} položiek";

  static String m25(price) => "Celkom: ${price}";

  static String m26(amount) => "Zaplatiť ${amount}";

  static String m27(total) => "Množstvo: ${total}";

  static String m28(percent) => "Zľava ${percent}%";

  static String m29(second) => " pred ${second} sek.";

  static String m30(totalCartQuantity) =>
      "Nákupný košík, ${totalCartQuantity} položiek";

  static String m31(numberOfUnitsSold) => "Predané: ${numberOfUnitsSold}";

  static String m32(fieldName) => "Pole ${fieldName} je povinné";

  static String m33(total) => "${total} produktov";
  ...
  static String m36(message) => "Upozornenie: ${message}";

  static String m37(defaultCurrency) =>
      "Aktuálna mena nie je dostupná pre funkciu Peňaženka. Zmeňte ju na ${defaultCurrency}";

  static String m38(length) => "Našli sme ${length} produktov";

  static String m39(week) => " ${week}. týždeň";

  static String m40(name) => "Vitajte ${name}";

  static String m41(year) => " pred${year} rokmi";

  static String m42(total) => "Pridelili ste objednávke č.${total}";
