...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "müssen in Gruppen von ${number}gekauft werden";

  static String m24(itemCount) => "${itemCount} Artikel";

  static String m25(price) => "Optionen insgesamt: ${price}";

  static String m26(amount) => "Zahlen Sie ${amount}";

  static String m27(total) => "Menge: ${total}";

  static String m28(percent) => "Ausverkauf ${percent} %";

  static String m29(second) => "Vor ${second} Sekunden";

  static String m30(totalCartQuantity) =>
      "Warenkorb, ${totalCartQuantity} Artikel";

  static String m31(numberOfUnitsSold) => "Verkauft: ${numberOfUnitsSold}";

  static String m32(fieldName) => "Das Feld ${fieldName} ist erforderlich";

  static String m33(total) => "${total} Produkte";
  ...
  static String m35(date) => "Gültig bis ${date}";

  static String m36(message) => "Warnung: ${message}";
  ...
  static String m38(length) => "Wir haben die Produkte gefunden";

  static String m39(week) => "Woche ${week}";

  static String m40(name) => "Willkommen ${name}";

  static String m41(year) => " Vor${year} Jahren";

  static String m42(total) => "Sie haben der Bestellung #${total}zugewiesen";
