...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "ต้องซื้อเป็นกลุ่มจำนวน ${number}";

  static String m24(itemCount) => "${itemCount} รายการ";

  static String m25(price) => "ตัวเลือกทั้งหมด: ${price}";

  static String m26(amount) => "ชำระเงิน ${amount}";

  static String m27(total) => "จำนวน: ${total}";

  static String m28(percent) => "ยอดขาย ${percent} %";

  static String m29(second) => "${second} วินาทีที่ผ่านมา";
  ...
  static String m32(fieldName) => "ต้องระบุช่อง ${fieldName} ";

  static String m33(total) => "${total} สินค้า";
  ...
  static String m35(date) => "ใช้ได้จนถึง ${date}";

  static String m36(message) => "คำเตือน: ${message}";
  ...
  static String m38(length) => "เราพบสินค้า ${length}";

  static String m39(week) => "สัปดาห์ ${week}";

  static String m40(name) => "ยินดีต้อนรับ ${name}";

  static String m41(year) => "${year} ปีที่แล้ว";

  static String m42(total) => "คุณได้มอบหมายคำสั่งซื้อ #${total}";
