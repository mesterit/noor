...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m25(price) => "Opções totais: ${price}";

  static String m26(amount) => "Pague ${amount}";

  static String m27(total) => "Qtd: ${total}";

  static String m28(percent) => "Poupe ${percent}%";
  ...
  static String m35(date) => "Válido até ${date}";
  ...
  static String m38(length) => "Encontramos ${length} produtos";
  ...
  static String m42(total) => "O pedido nº${total} foi atribuído";
