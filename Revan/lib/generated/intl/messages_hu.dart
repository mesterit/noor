...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => " ${number}csoportban kell megvásárolni";

  static String m24(itemCount) => "${itemCount} termékek";

  static String m25(price) => "Opciók összesen: ${price}";

  static String m26(amount) => "Fizetés: ${amount}";

  static String m27(total) => "Mennyiség: ${total}";

  static String m28(percent) => "${percent} % Kedvezmény";

  static String m29(second) => "${second} másodperce";
  ...
  static String m32(fieldName) => "A(z) ${fieldName} mező kitöltése kötelező";

  static String m33(total) => "${total} termék";
  ...
  static String m35(date) => "Érvényes: ${date}";

  static String m36(message) => "Figyelmeztetés: ${message}";
  ...
  static String m38(length) => "Találtunk ${length} terméket";

  static String m39(week) => " ${week}hét";

  static String m40(name) => "Üdvözöljük ${name}";

  static String m41(year) => "${year} évvel ezelőtt";

  static String m42(total) => "Hozzárendelte a (z)${total}számú megrendelést";
