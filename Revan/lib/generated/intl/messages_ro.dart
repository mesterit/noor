...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "trebuie cumpărat în grupuri de ${number}";

  static String m24(itemCount) => "${itemCount} articole";

  static String m25(price) => "Opțiuni totale: ${price}";

  static String m26(amount) => "Plătiți ${amount}";

  static String m27(total) => "Cantitate: ${total}";

  static String m28(percent) => "Reducere ${percent} %";

  static String m29(second) => "${second} secunde în urmă";

  static String m30(totalCartQuantity) =>
      "Coș de cumpărături, ${totalCartQuantity} articole";

  static String m31(numberOfUnitsSold) => "Vândut: ${numberOfUnitsSold}";

  static String m32(fieldName) => "Câmpul ${fieldName} este obligatoriu";

  static String m33(total) => "${total} articole";
  ...
  static String m35(date) => "Valabil până la ${date}";

  static String m36(message) => "Atenție: ${message}";
  ...
  static String m38(length) => "Am găsit ${length} articole";

  static String m39(week) => "Săptămâna ${week}";

  static String m40(name) => "Bun venit ${name}";

  static String m41(year) => " Acum${year} ani";

  static String m42(total) => "Ați atribuit comenzii nr.${total}";
