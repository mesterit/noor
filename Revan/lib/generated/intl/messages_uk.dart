...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "потрібно купувати групами по ${number}";

  static String m24(itemCount) => "${itemCount} елементів";

  static String m25(price) => "Всього варіантів: ${price}";

  static String m26(amount) => "Сплатити ${amount}";

  static String m27(total) => "Кількість: ${total}";

  static String m28(percent) => "Продаж ${percent}%";

  static String m29(second) => "${second} секунд тому";

  static String m30(totalCartQuantity) =>
      "Кошик, товарів: ${totalCartQuantity} ";

  static String m31(numberOfUnitsSold) => "Продано: ${numberOfUnitsSold}";

  static String m32(fieldName) => "Поле ${fieldName} є обов’язковим";

  static String m33(total) => "${total} продуктів";
  ...
  static String m35(date) => "Діє до ${date}";

  static String m36(message) => "Попередження: ${message}";

  static String m37(defaultCurrency) =>
      "Вибрана валюта зараз недоступна для функції Wallet. Змініть її на ${defaultCurrency}";

  static String m38(length) => "Ми знайшли ${length} продуктів";

  static String m39(week) => "Тиждень ${week}";

  static String m40(name) => "Ласкаво просимо ${name}";

  static String m41(year) => "${year} років тому";

  static String m42(total) => "Ви призначили замовлення №${total}";
