...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "nutno zakoupit ve skupinách po ${number}";

  static String m24(itemCount) => " Položky:${itemCount} ";

  static String m25(price) => "Celkem možností: ${price}";

  static String m26(amount) => "Zaplatit ${amount}";

  static String m27(total) => "Množství: ${total}";

  static String m28(percent) => "Výprodej ${percent}%";

  static String m29(second) => " Před${second} s";

  static String m30(totalCartQuantity) =>
      "Nákupní košík, položky: ${totalCartQuantity} ";

  static String m31(numberOfUnitsSold) => "Prodáno: ${numberOfUnitsSold}";

  static String m32(fieldName) => "Pole ${fieldName} je povinné";

  static String m33(total) => "${total} produktů";
  ...
  static String m35(date) => "Platí do ${date}";

  static String m36(message) => "Upozornění: ${message}";
  ...
  static String m38(length) => "Našli jsme ${length} produktů";

  static String m39(week) => "Týden ${week}";

  static String m40(name) => "Vítejte ${name}";

  static String m41(year) => " Před${year} lety";

  static String m42(total) => "Přiřadili jste k objednávce č.${total}";
