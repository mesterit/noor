...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "harus dibeli dalam kelompok ${number}";

  static String m24(itemCount) => "${itemCount} barang";

  static String m25(price) => "Total opsi: ${price}";

  static String m26(amount) => "Bayar ${amount}";

  static String m27(total) => "Jumlah: ${total}";

  static String m28(percent) => "Diskon ${percent} %";
  ...
  static String m32(fieldName) => "Bidang ${fieldName} wajib diisi";
  ...
  static String m35(date) => "Berlaku sampai ${date}";
  ...
  static String m38(length) => "Kami menemukan produk ${length}";

  static String m39(week) => "Minggu ${week}";

  static String m40(name) => "Selamat datang ${name}";

  static String m41(year) => "${year} tahun lalu";

  static String m42(total) => "Anda telah menetapkan untuk memesan #${total}";
