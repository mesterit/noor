...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => " ${number}အုပ်စုဖြင့် ဝယ်ယူရမည်";

  static String m24(itemCount) => "${itemCount} items";

  static String m25(price) => "Options total: ${price}";

  static String m26(amount) => " ${amount}ပေးချေပါ";
  ...
  static String m32(fieldName) => " ${fieldName} အကွက် လိုအပ်သည်။";
  ...
  static String m36(message) => "သတိပေးချက်: ${message}";
  ...
  static String m40(name) => "ကြိုဆိုပါတယ် ${name}";

  static String m41(year) => "${year} နှစ်အကြာက";
