...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "doit être acheté par groupes de ${number}";

  static String m24(itemCount) => "${itemCount} produits";

  static String m25(price) => "Total des options: ${price}";

  static String m26(amount) => "Payer ${amount}";

  static String m27(total) => "Qté: ${total}";

  static String m28(percent) => "Remise ${percent} %";

  static String m29(second) => "Il y a ${second} secondes";

  static String m30(totalCartQuantity) =>
      "Panier, ${totalCartQuantity} produits";

  static String m31(numberOfUnitsSold) => "Vendus: ${numberOfUnitsSold}";

  static String m32(fieldName) => "Le champ ${fieldName} est obligatoire";

  static String m33(total) => "${total} Produits";
  ...
  static String m35(date) => "Valable jusqu\'au ${date}";

  static String m36(message) => "Notice: ${message}";
  ...
  static String m38(length) => "Nous avons trouvé ${length} produits";

  static String m39(week) => "Semaine ${week}";

  static String m40(name) => "Bienvenue ${name}";

  static String m41(year) => "Il y a ${year} ans";

  static String m42(total) => "Vous etes affecté à la commande n°${total}";
