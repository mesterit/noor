...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "täytyy ostaa ryhmissä ${number}";

  static String m24(itemCount) => "${itemCount} kohdetta";

  static String m25(price) => "Vaihtoehdot yhteensä: ${price}";

  static String m26(amount) => "Maksa ${amount}";

  static String m27(total) => "Määrä: ${total}";

  static String m28(percent) => "Alennus ${percent}%";

  static String m29(second) => "${second} sekuntia sitten";

  static String m30(totalCartQuantity) =>
      "Ostoskori, ${totalCartQuantity} tuotetta";

  static String m31(numberOfUnitsSold) => "Myyty: ${numberOfUnitsSold}";

  static String m32(fieldName) => "Kenttä ${fieldName} on pakollinen";

  static String m33(total) => "${total} tuotetta";
  ...
  static String m35(date) => "Voimassa ${date}asti";

  static String m36(message) => "Varoitus: ${message}";
  ...
  static String m38(length) => "Löysimme ${length} tuotetta";

  static String m39(week) => "Viikko ${week}";

  static String m40(name) => "Tervetuloa ${name}";

  static String m41(year) => "${year} vuotta sitten";

  static String m42(total) => "Olet määrittänyt tilauksen #${total}";
