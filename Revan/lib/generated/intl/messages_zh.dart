...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m24(itemCount) => "${itemCount} 件商品";
  ...
  static String m28(percent) => "出售${percent}%";
  ...
  static String m33(total) => "${total} 个产品";
  ...
  static String m38(length) => "我们找到 ${length} 个产品";

  static String m39(week) => "周 ${week}";
