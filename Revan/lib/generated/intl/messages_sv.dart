...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "måste köpas i grupper om ${number}";

  static String m24(itemCount) => "${itemCount} objekt";

  static String m25(price) => "Totalt antal alternativ: ${price}";

  static String m26(amount) => "Betala ${amount}";

  static String m27(total) => "Antal: ${total}";

  static String m28(percent) => "Försäljning ${percent}%";

  static String m29(second) => " För${second} sekunder sedan";

  static String m30(totalCartQuantity) =>
      "Kundvagn, ${totalCartQuantity} artiklar";

  static String m31(numberOfUnitsSold) => "Såld: ${numberOfUnitsSold}";

  static String m32(fieldName) => "Fältet ${fieldName} är obligatoriskt";
  ...
  static String m35(date) => "Gäller till ${date}";

  static String m36(message) => "Varning: ${message}";
  ...
  static String m38(length) => "Vi hittade ${length} produkter";

  static String m39(week) => "Vecka ${week}";

  static String m40(name) => "Välkommen ${name}";

  static String m41(year) => " För${year} år sedan";

  static String m42(total) => "Du har tilldelat order nr${total}";
