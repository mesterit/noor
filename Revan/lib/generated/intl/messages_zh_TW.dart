...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "必須以 ${number}為一組購買";

  static String m24(itemCount) => "${itemCount} 項";

  static String m25(price) => "選項總數： ${price}";

  static String m26(amount) => "支付 ${amount}";

  static String m27(total) => "數量： ${total}";

  static String m28(percent) => "銷售額 ${percent}%";

  static String m29(second) => "${second} 秒前";

  static String m30(totalCartQuantity) => "購物車， ${totalCartQuantity} 件商品";

  static String m31(numberOfUnitsSold) => "已售出： ${numberOfUnitsSold}";

  static String m32(fieldName) => " ${fieldName} 字段是必需的";

  static String m33(total) => "${total} 個商品";
  ...
  static String m38(length) => "我們找到了 ${length} 件商品";

  static String m39(week) => "第 ${week} 週";

  static String m40(name) => "歡迎 ${name}";

  static String m41(year) => "${year} 年前";

  static String m42(total) => "您已指定訂單 #${total}";
