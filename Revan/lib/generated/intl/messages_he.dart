...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "יש לקנות בקבוצות של ${number}";

  static String m24(itemCount) => "${itemCount} פריטים";

  static String m25(price) => "סה\"כ אפשרויות: ${price}";

  static String m26(amount) => "שלם ${amount}";

  static String m27(total) => "כמות: ${total}";

  static String m28(percent) => "הנחה ${percent}%";

  static String m29(second) => "לפני ${second} שניות";

  static String m30(totalCartQuantity) =>
      "עגלת קניות, ${totalCartQuantity} פריטים";

  static String m31(numberOfUnitsSold) => "נמכר: ${numberOfUnitsSold}";

  static String m32(fieldName) => "השדה ${fieldName} נדרש";

  static String m33(total) => "${total} מוצרים";
  ...
  static String m35(date) => "תקף עד ${date}";

  static String m36(message) => "אזהרה: ${message}";

  static String m37(defaultCurrency) =>
      "המטבע שנבחר כרגע אינו זמין עבור תכונת הארנק, שנה אותו ל- ${defaultCurrency}";

  static String m38(length) => "מצאנו ${length} מוצרים";

  static String m39(week) => "שבוע ${week}";

  static String m40(name) => "ברוך הבא ${name}";

  static String m41(year) => " לפני${year} שנים";

  static String m42(total) => "הקצית להזמין מספר${total}";
