...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "mora se kupiti u grupama od ${number}";

  static String m24(itemCount) => "${itemCount} proizvoda";

  static String m25(price) => "Ukupno opcija: ${price}";

  static String m26(amount) => "Plati ${amount}";

  static String m27(total) => "Količina: ${total}";

  static String m28(percent) => "Rasprodaja ${percent}%";

  static String m29(second) => "${second} sekundi prije";

  static String m30(totalCartQuantity) =>
      "Korpa za kupovinu, ${totalCartQuantity} proizvoda";

  static String m31(numberOfUnitsSold) => "Prodano: ${numberOfUnitsSold}";

  static String m32(fieldName) => "Polje ${fieldName} je obavezno";

  static String m33(total) => "${total} proizvoda";
  ...
  static String m35(date) => "Validno do ${date}";

  static String m36(message) => "Upozorenje: ${message}";
  ...
  static String m38(length) => "Pronašli smo ${length} proizvoda";

  static String m39(week) => "Sedmica ${week}";

  static String m40(name) => "Dobro došli ${name}";

  static String m41(year) => "${year} godine prije";

  static String m42(total) => "Dodijeljeni ste narudžbi #${total}";
