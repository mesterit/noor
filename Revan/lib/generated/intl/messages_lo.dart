...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "ຕ້ອງຊື້ເປັນກຸ່ມຂອງ ${number}";

  static String m24(itemCount) => "${itemCount} ລາຍການ";

  static String m25(price) => "ຕົວເລືອກທັງໝົດ: ${price}";

  static String m26(amount) => "ຈ່າຍ ${amount}";

  static String m27(total) => "ຈຳນວນ: ${total}";

  static String m28(percent) => "ຂາຍ ${percent}%";

  static String m29(second) => "${second} ວິນາທີກ່ອນ";

  static String m30(totalCartQuantity) =>
      "ກະຕ່າເຄື່ອງ, ${totalCartQuantity} ລາຍການ";

  static String m31(numberOfUnitsSold) => "ຂາຍແລ້ວ: ${numberOfUnitsSold}";

  static String m32(fieldName) => "ຕ້ອງມີຊ່ອງຂໍ້ມູນ ${fieldName} ";

  static String m33(total) => "${total} ຜະລິດຕະພັນ";
  ...
  static String m35(date) => "ໃຊ້ໄດ້ຈົນຮອດ ${date}";

  static String m36(message) => "ຄຳເຕືອນ: ${message}";

  static String m37(defaultCurrency) =>
      "ສະກຸນເງິນທີ່ເລືອກໃນປັດຈຸບັນບໍ່ສາມາດໃຊ້ໄດ້ກັບ Wallet, ກະລຸນາປ່ຽນເປັນ ${defaultCurrency}";

  static String m38(length) => "ພວກເຮົາພົບເຫັນ ${length} ຜະລິດຕະພັນ";

  static String m39(week) => "ອາທິດ ${week}";

  static String m40(name) => "ຍິນດີຕ້ອນຮັບ ${name}";

  static String m41(year) => "${year} ປີກ່ອນ";

  static String m42(total) => "ທ່ານໄດ້ມອບໝາຍໃຫ້ສັ່ງ #${total}";
