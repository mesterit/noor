...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "lazima inunuliwe katika vikundi vya ${number}";

  static String m24(itemCount) => "${itemCount} vitu";

  static String m25(price) => "Jumla ya chaguo: ${price}";

  static String m26(amount) => "Lipa ${amount}";

  static String m27(total) => "Kiasi: ${total}";

  static String m28(percent) => "Uuzaji ${percent}%";

  static String m29(second) => " sekunde${second} zilizopita";

  static String m30(totalCartQuantity) =>
      "Rukwama ya ununuzi, ${totalCartQuantity} vitu";

  static String m31(numberOfUnitsSold) => "Zinauzwa: ${numberOfUnitsSold}";

  static String m32(fieldName) => "Sehemu ya ${fieldName} inahitajika";

  static String m33(total) => "${total} bidhaa";
  ...
  static String m35(date) => "Inatumika hadi ${date}";

  static String m36(message) => "Onyo: ${message}";
  ...
  static String m38(length) => "Tulipata bidhaa ${length} ";

  static String m39(week) => "Wiki ${week}";

  static String m40(name) => "Karibu ${name}";

  static String m41(year) => " miaka${year} iliyopita";

  static String m42(total) => "Umekabidhi kuagiza #${total}";
