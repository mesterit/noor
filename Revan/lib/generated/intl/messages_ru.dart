...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => "необходимо покупать группами по ${number}";

  static String m24(itemCount) => "${itemCount} товаров";

  static String m25(price) => "Всего вариантов: ${price}";

  static String m26(amount) => "Оплатить ${amount}";

  static String m27(total) => "Кол-во: ${total}";

  static String m28(percent) => "Распродажа ${percent} %";

  static String m29(second) => "${second} секунд назад";
  ...
  static String m32(fieldName) =>
      "Поле ${fieldName} обязательно для заполнения";

  static String m33(total) => "${total} продуктов";
  ...
  static String m35(date) => "Действительно до ${date}";

  static String m36(message) => "Предупреждение: ${message}";
  ...
  static String m38(length) => "Мы нашли товары";

  static String m39(week) => "Неделя ${week}";

  static String m40(name) => "Добро пожаловать ${name}";

  static String m41(year) => "${year} лет назад";

  static String m42(total) => "Вы назначили заказ №${total}";
