...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(number) => " ${number}کے گروپوں میں خریدنا ضروری ہے";

  static String m24(itemCount) => "${itemCount} آئٹمز";

  static String m25(price) => "کل اختیارات: ${price}";

  static String m26(amount) => "ادائیگی کریں ${amount}";

  static String m27(total) => "مقدار: ${total}";

  static String m28(percent) => "فروخت ${percent}%";

  static String m29(second) => "${second} سیکنڈ پہلے";

  static String m30(totalCartQuantity) =>
      "شاپنگ کارٹ، ${totalCartQuantity} آئٹمز";

  static String m31(numberOfUnitsSold) => "فروخت کیا گیا: ${numberOfUnitsSold}";

  static String m32(fieldName) => " ${fieldName} فیلڈ درکار ہے۔";

  static String m33(total) => "${total} مصنوعات";
  ...
  static String m35(date) => " ${date}تک درست";

  static String m36(message) => "انتباہ: ${message}";
  ...
  static String m38(length) => "ہمیں ${length} پروڈکٹس ملے";

  static String m39(week) => "ہفتہ ${week}";

  static String m40(name) => "خوش آمدید ${name}";

  static String m41(year) => "${year} سال پہلے";

  static String m42(total) => "آپ نے آرڈر #${total}کو تفویض کیا ہے";
