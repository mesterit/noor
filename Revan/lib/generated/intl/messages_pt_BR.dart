...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(country) => "${country} país não é suportado";

  static String m7(currency) => "${currency} não é suportado";
  ...
  static String m23(number) => "deve ser comprado em grupos de ${number}";

  static String m24(itemCount) => "${itemCount} itens";

  static String m25(price) => "Opções no total: ${price}";

  static String m26(amount) => "Pague ${amount}";

  static String m27(total) => "Qtd: ${total}";

  static String m28(percent) => "Venda ${percent}%";

  static String m29(second) => "${second} segundos atrás";

  static String m30(totalCartQuantity) =>
      "Carrinho de compras, itens ${totalCartQuantity}";

  static String m31(numberOfUnitsSold) => "Vendido: ${numberOfUnitsSold}";

  static String m32(fieldName) => "O campo ${fieldName} é obrigatório";

  static String m33(total) => "${total} produtos";
  ...
  static String m36(message) => "Aviso: ${message}";
  ...
  static String m38(length) => "Encontrámos ${length} produtos";

  static String m39(week) => "Semana ${week}";

  static String m40(name) => "Bem-vindo ${name}";

  static String m41(year) => "${year} anos atrás";

  static String m42(total) => "Você atribuiu a ordem #${total}";
